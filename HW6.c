...
static void sphere2(double x,double y,double z,double dx, double dy, double dz)
{
   const int d=15;
...
void display()
{
   ...
   //  Draw scene
    field(4,0.5,0,-2.0,2);
    //draw_football(0,0,0, 0.5,0.5,0.5, 0.5,0);
  
    draw_cylinder(-0.25,2.5,0, 0.5,4.0, 0);
    draw_cylinder(1.75,2.5,0, 0.5,4.0, 0);
    draw_cylinder(0.5,2.5,0,  0.5,3.0, 90);
    draw_cylinder(-0.5,2.5,0, 0.5,3.0, 90);
    draw_cylinder(0.75,2.5,0, 0.5,4.0, 180);
    
    
    draw_cylinder(-0.25,-2.5,0, 0.5,4.0, 0);
    draw_cylinder(1.75,-2.5,0, 0.5,4.0, 0);
    draw_cylinder(0.5,0-2.5,0,  0.5,3.0, 90);
    draw_cylinder(-0.5,-2.5,0, 0.5,3.0, 90);
    draw_cylinder(0.75,-2.5,0, 0.5,4.0, 180);
...
int main(int argc,char* argv[])
{
   ...
   glutCreateWindow("Textures and Lighting Tayvian Wallace");
#ifdef USEGLEW
   //  Initialize GLEW
