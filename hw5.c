 ...
 *  Lighting
 *
 *  Demonstrates basic lighting using GoalPosts and a Ground
 *
 *  Key bindings:
 *  l          Toggles lighting
...
/*
void draw_box(float x, float y, float z,float dx, float dy, float dz, float th)
{
    glPushMatrix();
    //  Offset, scale and rotate
    glTranslated(x,y,z);
...
/*
static void goal_posts(float x, float y, float z,float s,float th)
{
...
static void football(float x, float y, float z, float dx, float dy, float dz, float th){
...
/*
void bleachers(float l, float x, float y, float z){
...
void display()
{
   ...
   if (light)
   {
      ...
      glColor3f(1,1,1);
      ball(Position[2]+1,Position[1]/2,Position[2]/2, 0.1);
   ...
   {
       /*
       field(4,0.75,0,-2.0, 2);
       //goal_posts(0,0.0,0.0, 1.0, 0);
       //goal_posts(0.25,-1.0,0.0, 1.0, -90.0);
      // goal_posts(0.5,0.0,0.0, 1.0, 0.0);
       //goal_posts(0.25,0.0,0.0,  00.0);
      //cube(+1,0,0 , 0.5,0.5,0.5 , 0);
       //ball(0,0,1 , 0.5);
        */
       
       field(4,0.75,0,-2.0,2);
       draw_cylinder(-0.25,0,0, 0.5,4.0, 0);
       draw_cylinder(1.75,0,0, 0.5,4.0, 0);
       draw_cylinder(0.5,0,0,  0.5,3.0, 90);
       draw_cylinder(-0.5,0,0, 0.5,3.0, 90);
       draw_cylinder(0.75,0,0, 0.5,4.0, 180);
    
       
       //draw_cylinder(-4.25,0,1, 0.5,4.0, 0);
   }
